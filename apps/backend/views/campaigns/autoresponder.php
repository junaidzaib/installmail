        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $campaign, 'columns' => array('campaign_id', 'campaign_uid', 'customer_id', 'name', 'type', 'group_id', 'list_id', 'segment_id', 'send_at', 'status', 'search_ar_event', 'search_ar_time', 'search_template_name', 'gridViewSent', 'gridViewDelivered', 'gridViewOpens', 'gridViewClicks', 'gridViewBounces', 'gridViewUnsubs')), true), $itemsCount)
