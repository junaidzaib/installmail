...
/**
 * FieldBuilderTypeRatingSubscriber
 * 
...
class FieldBuilderTypeRatingSubscriber extends CBehavior
{
    /**
     * @param CEvent $event
     * @throws CException
    ...
    protected function getValueModels()
    {
        ...
        $models = ListFieldRating::model()->findAllByAttributes(array(
    ...
    protected function buildFieldArray($model)
    {
        ...
        if ($field->visibility == ListFieldRating::VISIBILITY_VISIBLE || Yii::app()->apps->isAppName('customer')) {
