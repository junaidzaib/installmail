...
/**
 * FieldBuilderTypePhonenumberResponder
 * 
...
class FieldBuilderTypePhonenumberResponder extends CBehavior
{
    // register at init
    public function attach($owner)
    {
	    ...
	    $errorsMap = CJavaScript::jsonEncode(array(
            Yii::t('survey_fields', 'Invalid number'),
            Yii::t('survey_fields', 'Invalid country code'),
            Yii::t('survey_fields', 'Too short'),
            Yii::t('survey_fields', 'Too long'),
            Yii::t('survey_fields', 'Invalid number')
        ));
