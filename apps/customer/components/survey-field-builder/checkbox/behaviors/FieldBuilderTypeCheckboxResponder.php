...
/**
 * FieldBuilderTypeCheckboxResponder
 * 
...
class FieldBuilderTypeCheckboxResponder extends CBehavior
{
    /**
     * @param CEvent $event
     * @throws CException
    ...
    protected function getValueModels()
    {
        ...
        $models = SurveyFieldCheckbox::model()->findAllByAttributes(array(
        ...
        foreach ($models as $model) {
            ...
            $defaultValue = strlen(trim((string)$valueModel->value)) == 0 ? $model->default_value : $valueModel->value;
    ...
    protected function buildFieldArray($model)
    {
        ...
        if ($field->visibility == SurveyFieldCheckbox::VISIBILITY_VISIBLE || Yii::app()->apps->isAppName('customer')) {
