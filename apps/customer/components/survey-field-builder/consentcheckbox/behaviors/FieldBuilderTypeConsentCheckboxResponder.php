...
/**
 * FieldBuilderTypeConsentCheckboxResponder
 * 
...
class FieldBuilderTypeConsentCheckboxResponder extends CBehavior
{
    /**
     * @param CEvent $event
     * @throws CException
    ...
    protected function buildFieldArray($model)
    {
        ...
        if ($field->visibility == SurveyFieldConsentCheckbox::VISIBILITY_VISIBLE || Yii::app()->apps->isAppName('customer')) {
