...
/**
 * FieldBuilderTypeCheckboxlistResponder
 * 
...
class FieldBuilderTypeCheckboxlistResponder extends CBehavior
{
    ...
    protected function getValueModels()
    {
        ...
        foreach ($models as $model) {
            ...
            $hasOptionsSet = SurveyFieldValue::model()->countByAttributes(array(
