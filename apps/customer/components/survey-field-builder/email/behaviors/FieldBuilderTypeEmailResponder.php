...
/**
 * FieldBuilderTypeEmailResponder
 * 
...
class FieldBuilderTypeEmailResponder extends CBehavior
{
    ...
    public function _setCorrectValidationRules(CModelEvent $event)
    {
        ...
        $rules->add(array('value', 'email', 'validateIDN' => true));
        $rules->add(array('value', 'length', 'min' => 3, 'max' => 150));
    }
